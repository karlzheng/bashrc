...
''')
    ...
    isExists=os.path.exists('/etc/ppp/ip-pre-up')
    if isExists:
        os.remove('/etc/ppp/ip-pre-up')
    isExists=os.path.exists('/etc/ppp/ip-down.d/ip-down')
    if isExists:
        os.remove('/etc/ppp/ip-down.d/ip-down')

    shutil.move('ip-pre-up','/etc/ppp/')
    shutil.move('ip-down','/etc/ppp/ip-down.d/')
