...
mkbootfs ./root | minigzip > ./ramdisk-recovery.img

mkimage -A arm -O linux -T ramdisk -C none -a 0x30800000 -n "ramdisk" -d ./ramdisk-recovery.img ./ramdisk-recovery-uboot.img

mkbootimg --kernel ./zImage --ramdisk ./ramdisk-recovery-uboot.img -o ./recovery-uboot.img
